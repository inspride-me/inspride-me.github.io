      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            sharedHashesByProp = route.sharedHashesByProp, templateIndex = route.templateIndex, data = route.data, sharedData = route.sharedData, routePath = route.path;
          ...
          case 20:
            ...
            _context.next = 23;
            return config.renderToElement(FinalComp, {
              meta: renderMeta,
