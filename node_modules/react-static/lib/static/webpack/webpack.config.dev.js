...
var _default = function _default(_ref) {
  ...
  return {
    ...
    entry: [require.resolve('react-dev-utils/webpackHotDevClient'), require.resolve('webpack/hot/only-dev-server'), config.disableRuntime ? null : require.resolve('../../bootstrapTemplates'), _path.default.resolve(ROOT, config.entry)].filter(Boolean),
    output: {
      filename: '[name].js',
      // never hash dev code
    ...
    resolve: {
      modules: _toConsumableArray([SRC, NODE_MODULES, _path.default.resolve(__dirname, '../../../node_modules'), DIST].map(function (d) {
